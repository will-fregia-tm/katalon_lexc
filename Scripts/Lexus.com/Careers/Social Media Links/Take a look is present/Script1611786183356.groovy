...
WebUI.scrollToElement(findTestObject('Careers/Header Ready to join'), 0)

WebUI.verifyElementPresent(findTestObject('Careers/Header Take a look'), 4, FailureHandling.STOP_ON_FAILURE)

VariableText = WebUI.getText(findTestObject('Careers/Header Take a look'))

modifiedString = (VariableText - 'LEXUS')

WebUI.verifyNotMatch(modifiedString, VariableText, false, FailureHandling.STOP_ON_FAILURE)
