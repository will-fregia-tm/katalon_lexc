...
'Hero image'
WebUI.verifyElementPresent(findTestObject('Careers/Hero Image'), 4, FailureHandling.STOP_ON_FAILURE)

pagewidth = WebUI.getPageWidth()

imagewidth = WebUI.getCSSValue(findTestObject('Careers/Hero Image'), 'width')
