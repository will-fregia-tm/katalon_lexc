...
if (WebUI.verifyMatch(GlobalVariable.legacy, 'yes', false, FailureHandling.OPTIONAL)) {
    ...
    WebUI.setText(findTestObject('HomePage/HeroOffers/hero offers - zip entry field'), '30303')
...
if (WebUI.verifyMatch(GlobalVariable.legacy, 'no', false, FailureHandling.OPTIONAL)) {
    ...
    if (WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/zip code field'), 5, FailureHandling.OPTIONAL)) {
        ...
        WebUI.scrollToElement(findTestObject('Homepage/HeroOffers/offer cards row'), 0, FailureHandling.STOP_ON_FAILURE)

        WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/cookied zip code - 75218'), 0, FailureHandling.STOP_ON_FAILURE)
        ...
        WebUI.setText(findTestObject('Homepage/HeroOffers/zip code field'), '30303')
        ...
        WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/cookied zip code - 30303'), 0, FailureHandling.STOP_ON_FAILURE)
    }
