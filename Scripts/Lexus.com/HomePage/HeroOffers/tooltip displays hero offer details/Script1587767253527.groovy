...
WebUI.waitForElementPresent(findTestObject('HomePage/HeroOffers/All Offers - offer details slider 2'), 0)

WebUI.click(findTestObject('HomePage/HeroOffers/All Offers - offer details slider 2'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('HomePage/HeroOffers/All Offers - offer details - Lexus Financial Services'), 
