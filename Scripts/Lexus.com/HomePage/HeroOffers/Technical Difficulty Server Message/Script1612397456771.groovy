...
if (WebUI.verifyMatch(GlobalVariable.legacy, 'no', false, FailureHandling.OPTIONAL)) {
    ...
    if (WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/zip code field'), 5, FailureHandling.OPTIONAL)) {
        ...
        WebUI.setText(findTestObject('Homepage/HeroOffers/zip code field'), '00003')

		WebUI.click(findTestObject('Homepage/HeroOffers/submit button'))
		
		WebUI.waitForElementPresent(findTestObject('Homepage/HeroOffers/technical difficulty server message'), 5, FailureHandling.OPTIONAL)
		
		WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/technical difficulty server message'), 0, FailureHandling.STOP_ON_FAILURE)
    }
