...
if (WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/zip code field'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/SharedMarketOverlay/showing results text'), 0, FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/SharedMarketOverlay/displayed zip code - 08008'), 0, 
        FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/SharedMarketOverlay/change zip CTA'), 0, FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/SharedMarketOverlay/displayed market name - New York, New Jersey, Connecticut Dealers'), 
        0, FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/SharedMarketOverlay/displayed market name - New Jersey, Delaware, Pennsylvania Dealers'), 
        0, FailureHandling.CONTINUE_ON_FAILURE)
}
