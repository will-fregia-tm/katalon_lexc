...
if (WebUI.verifyMatch(GlobalVariable.legacy, 'no', false, FailureHandling.OPTIONAL)) {
    ...
    if (WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/zip code field'), 5, FailureHandling.OPTIONAL)) {
        ...
        WebUI.click(findTestObject('Homepage/HeroOffers/ZipBar/change market CTA'), FailureHandling.OPTIONAL)

        WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/ZipBar/previously entered zip - 75219'), 0, FailureHandling.OPTIONAL)

        WebUI.setText(findTestObject('Homepage/HeroOffers/ZipBar/zip entry field'), '08008', FailureHandling.OPTIONAL)

        WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/ZipBar/numbers in zip input - 08008'), 2, FailureHandling.OPTIONAL)

        WebUI.click(findTestObject('Homepage/HeroOffers/ZipBar/search icon'), FailureHandling.OPTIONAL)
        ...
        WebUI.verifyElementVisible(findTestObject('Homepage/HeroOffers/SharedMarketOverlay/headline copy'), FailureHandling.OPTIONAL)

        WebUI.click(findTestObject('Homepage/HeroOffers/SharedMarketOverlay/change zip CTA'), FailureHandling.OPTIONAL)

        WebUI.waitForElementPresent(findTestObject('Homepage/HeroOffers/form input'), 0, FailureHandling.OPTIONAL)

        WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/form input with cookied zip - 08008'), 0, FailureHandling.OPTIONAL)
    }
