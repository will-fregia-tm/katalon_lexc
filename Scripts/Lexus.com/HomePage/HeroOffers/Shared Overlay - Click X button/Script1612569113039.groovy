...
if (WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/zip code field'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.click(findTestObject('Homepage/HeroOffers/SharedMarketOverlay/X button'), FailureHandling.STOP_ON_FAILURE)

    WebUI.waitForElementPresent(findTestObject('Homepage/HeroOffers/zip code field'), 0, FailureHandling.OPTIONAL)
