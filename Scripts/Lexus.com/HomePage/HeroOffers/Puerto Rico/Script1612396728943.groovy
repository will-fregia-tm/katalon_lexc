...
if (WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/zip code field'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.setText(findTestObject('Homepage/HeroOffers/form input'), '00601')

    WebUI.click(findTestObject('Homepage/HeroOffers/submit button'))

    WebUI.waitForElementPresent(findTestObject('Homepage/HeroOffers/puerto rico server message'), 5, FailureHandling.OPTIONAL)

    WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/puerto rico server message'), 0, FailureHandling.STOP_ON_FAILURE)

    WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/PR dealer site Lexus CTA'), 0, FailureHandling.STOP_ON_FAILURE)

    WebUI.click(findTestObject('Homepage/HeroOffers/PR dealer site Lexus CTA'), FailureHandling.OPTIONAL)
