...
if (WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/zip code field'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.setText(findTestObject('Homepage/HeroOffers/zip code field'), '96701')

    WebUI.click(findTestObject('Homepage/HeroOffers/submit button'))

    WebUI.waitForElementPresent(findTestObject('Homepage/HeroOffers/hawaii server message'), 5, FailureHandling.OPTIONAL)

    WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/hawaii server message'), 0, FailureHandling.STOP_ON_FAILURE)

    WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/Servco Lexus CTA'), 0, FailureHandling.STOP_ON_FAILURE)

    WebUI.click(findTestObject('Homepage/HeroOffers/Servco Lexus CTA'), FailureHandling.OPTIONAL)
