...
WebUI.setText(findTestObject('HomePage/HeroOffers/hero offers - zip entry field'), '11111')
...
WebUI.setText(findTestObject('HomePage/HeroOffers/hero offers - zip entry field'), '1111')

WebUI.click(findTestObject('HomePage/HeroOffers/hero offers - search button'))

WebUI.waitForElementVisible(findTestObject('HomePage/HeroOffers/hero offers - validation error message'), 0)

WebUI.verifyElementVisibleInViewport(findTestObject('HomePage/HeroOffers/hero offers - validation error message'), 0)

WebUI.click(findTestObject('HomePage/HeroOffers/hero offers - zip entry field'))

WebUI.setText(findTestObject('HomePage/HeroOffers/hero offers - zip entry field'), 'abcde')
