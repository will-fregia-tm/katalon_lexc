...
if (WebUI.verifyMatch(GlobalVariable.legacy, 'no', false, FailureHandling.OPTIONAL)) {
    ...
    if (WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/zip code field'), 5, FailureHandling.OPTIONAL)) {
        ...
        WebUI.setText(findTestObject('Homepage/HeroOffers/zip code field'), '1234')

		WebUI.click(findTestObject('Homepage/HeroOffers/submit button'))
		
		WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/form input'), 0, FailureHandling.STOP_ON_FAILURE)

		WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/error message'), 0, FailureHandling.STOP_ON_FAILURE)
		
		errorState = WebUI.getCSSValue(findTestObject('Homepage/HeroOffers/error state'), 'border-top-color', FailureHandling.OPTIONAL)
