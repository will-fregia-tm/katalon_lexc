...
if (WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/zip code field'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.click(findTestObject('Homepage/HeroOffers/ExpandSearch/dealer name - Lexus of Maplewood'))

    WebUI.waitForElementPresent(findTestObject('Homepage/HeroOffers/offer cards row'), 0, FailureHandling.STOP_ON_FAILURE)

    WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/offer cards row'), 0, FailureHandling.STOP_ON_FAILURE)

    WebUI.verifyElementNotPresent(findTestObject('Homepage/HeroOffers/ExpandSearch/expand zip overlay'), 0, FailureHandling.STOP_ON_FAILURE)

    WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/cookied zip code - 55109'), 0, FailureHandling.STOP_ON_FAILURE)
}
