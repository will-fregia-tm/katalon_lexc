...
if (WebUI.verifyMatch(GlobalVariable.legacy, 'no', false, FailureHandling.OPTIONAL)) {
    ...
    if (WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/zip code field'), 5, FailureHandling.OPTIONAL)) {
        ...
        WebUI.setText(findTestObject('Homepage/HeroOffers/zip code field'), '70878')
		...
		WebUI.waitForElementPresent(findTestObject('Homepage/HeroOffers/ExpandSearch/invalid zip message'), 5, FailureHandling.OPTIONAL)
		
		WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/ExpandSearch/invalid zip message'), 5, FailureHandling.STOP_ON_FAILURE)
    }
