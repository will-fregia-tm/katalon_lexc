...
if (WebUI.verifyElementPresent(findTestObject('Homepage/HeroOffers/zip code field'), 5, FailureHandling.OPTIONAL)) {
    ...
    noHover = WebUI.getCSSValue(findTestObject('Homepage/HeroOffers/ExpandSearch/displayed dealer 1'), 'background-color', 
        FailureHandling.STOP_ON_FAILURE)

    WebUI.mouseOver(findTestObject('Homepage/HeroOffers/ExpandSearch/displayed dealer 1'), FailureHandling.OPTIONAL)

    hoverState = WebUI.getCSSValue(findTestObject('Homepage/HeroOffers/ExpandSearch/displayed dealer 1'), 'background-color', 
        FailureHandling.STOP_ON_FAILURE)
    ...
    noHover = WebUI.getCSSValue(findTestObject('Homepage/HeroOffers/ExpandSearch/displayed dealer 2'), 'background-color', 
        FailureHandling.STOP_ON_FAILURE)

    WebUI.mouseOver(findTestObject('Homepage/HeroOffers/ExpandSearch/displayed dealer 2'), FailureHandling.OPTIONAL)

    hoverState = WebUI.getCSSValue(findTestObject('Homepage/HeroOffers/ExpandSearch/displayed dealer 2'), 'background-color', 
        FailureHandling.STOP_ON_FAILURE)
    ...
    noHover = WebUI.getCSSValue(findTestObject('Homepage/HeroOffers/ExpandSearch/displayed dealer 3'), 'background-color', 
        FailureHandling.STOP_ON_FAILURE)

    WebUI.mouseOver(findTestObject('Homepage/HeroOffers/ExpandSearch/displayed dealer 3'), FailureHandling.OPTIONAL)

    hoverState = WebUI.getCSSValue(findTestObject('Homepage/HeroOffers/ExpandSearch/displayed dealer 3'), 'background-color', 
        FailureHandling.STOP_ON_FAILURE)
    ...
    noHover = WebUI.getCSSValue(findTestObject('Homepage/HeroOffers/ExpandSearch/displayed dealer 6'), 'background-color', 
        FailureHandling.STOP_ON_FAILURE)

    WebUI.mouseOver(findTestObject('Homepage/HeroOffers/ExpandSearch/displayed dealer 6'), FailureHandling.STOP_ON_FAILURE)

    hoverState = WebUI.getCSSValue(findTestObject('Homepage/HeroOffers/ExpandSearch/displayed dealer 6'), 'background-color', 
        FailureHandling.STOP_ON_FAILURE)
