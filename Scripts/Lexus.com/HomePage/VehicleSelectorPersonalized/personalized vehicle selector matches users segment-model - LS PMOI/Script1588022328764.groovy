...
WebUI.navigateToUrl(GlobalVariable.SC_Domain + '/?personalization_id=inmarket_ls&audience=inmarket&campaign_vehicle_model=LS')

WebUI.navigateToUrl(GlobalVariable.SC_Domain_Unauthenticated + '/?personalization_id=inmarket_ls&audience=inmarket&campaign_vehicle_model=LS')
...
WebUI.verifyElementNotVisible(findTestObject('MSRP/section objects/homepage/vehicle selector/vehicle selector - SUVs - RX starting at price'))
