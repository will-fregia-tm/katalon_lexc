...
WebUI.navigateToUrl(GlobalVariable.SC_Domain + '/?personalization_id=inmarket_es&audience=inmarket&campaign_vehicle_model=ES')

WebUI.navigateToUrl(GlobalVariable.SC_Domain_Unauthenticated + '/?personalization_id=inmarket_es&audience=inmarket&campaign_vehicle_model=ES')
