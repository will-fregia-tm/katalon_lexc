...
WebUI.navigateToUrl(GlobalVariable.SC_Domain + '/?personalization_id=inmarket_gs&audience=inmarket&campaign_vehicle_model=GS')

WebUI.navigateToUrl(GlobalVariable.SC_Domain_Unauthenticated + '/?personalization_id=inmarket_gs&audience=inmarket&campaign_vehicle_model=GS')
