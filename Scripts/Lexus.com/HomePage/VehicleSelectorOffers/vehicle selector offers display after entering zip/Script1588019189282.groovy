...
WebUI.scrollToElement(findTestObject('HomePage/HeroOffers/hero offers - market name - 75218'), 0, FailureHandling.OPTIONAL)

WebUI.verifyElementVisible(findTestObject('HomePage/HeroOffers/hero offers - market name - 75218'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('HomePage/HeroOffers/All Offers - offer details slider 2'), FailureHandling.OPTIONAL)

WebUI.verifyElementPresent(findTestObject('HomePage/HeroOffers/offer tiles/All Offers - offer details - TX'), 0, FailureHandling.OPTIONAL)
...
not_run: WebUI.click(findTestObject('HomePage/VehicleSelector/categories/Sedans'))

not_run: WebUI.waitForElementVisible(findTestObject('HomePage/VehicleSelector/models/Sedans - IS'), 0)

WebUI.verifyElementPresent(findTestObject('HomePage/VehicleSelector/vehicle selector - offers heading'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToElement(findTestObject('HomePage/VehicleSelector/vehicle selector - offers heading'), 0, FailureHandling.STOP_ON_FAILURE)
