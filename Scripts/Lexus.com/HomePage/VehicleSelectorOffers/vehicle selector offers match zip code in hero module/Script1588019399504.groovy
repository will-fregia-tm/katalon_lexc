...
WebUI.click(findTestObject('HomePage/VehicleSelector/vehicle selector - offer details slider 1'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('HomePage/VehicleSelector/vehicle selector - offer details slider 2'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('HomePage/VehicleSelector/vehicle selector - offer details slider 3'), FailureHandling.OPTIONAL)

WebUI.verifyElementPresent(findTestObject('HomePage/VehicleSelector/vehicle selector - offer details - TX'), 0)

WebUI.click(findTestObject('HomePage/VehicleSelector/vehicle selector - offer details - TX'), FailureHandling.OPTIONAL)
