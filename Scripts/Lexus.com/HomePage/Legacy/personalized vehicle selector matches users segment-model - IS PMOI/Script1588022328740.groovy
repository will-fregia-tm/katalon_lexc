...
WebUI.navigateToUrl(GlobalVariable.SC_Domain + '/?personalization_id=inmarket_is&audience=inmarket&campaign_vehicle_model=IS')

WebUI.navigateToUrl(GlobalVariable.SC_Domain_Unauthenticated + '/?personalization_id=inmarket_is&audience=inmarket&campaign_vehicle_model=IS')
