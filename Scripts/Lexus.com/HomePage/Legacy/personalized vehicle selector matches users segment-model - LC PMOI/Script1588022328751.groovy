...
WebUI.navigateToUrl(GlobalVariable.SC_Domain + '/?personalization_id=inmarket_lc&audience=inmarket&campaign_vehicle_model=LC')

WebUI.navigateToUrl(GlobalVariable.SC_Domain_Unauthenticated + '/?personalization_id=inmarket_lc&audience=inmarket&campaign_vehicle_model=LC')
