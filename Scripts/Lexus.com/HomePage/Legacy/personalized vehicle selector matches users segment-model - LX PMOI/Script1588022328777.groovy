...
WebUI.navigateToUrl(GlobalVariable.SC_Domain + '/?personalization_id=inmarket_lx&audience=inmarket&campaign_vehicle_model=LX')

WebUI.navigateToUrl(GlobalVariable.SC_Domain_Unauthenticated + '/?personalization_id=inmarket_lx&audience=inmarket&campaign_vehicle_model=LX')
