...
WebUI.navigateToUrl(GlobalVariable.SC_Domain + '/?personalization_id=inmarket_gx&audience=inmarket&campaign_vehicle_model=GX')

WebUI.navigateToUrl(GlobalVariable.SC_Domain_Unauthenticated + '/?personalization_id=inmarket_gx&audience=inmarket&campaign_vehicle_model=GX')
