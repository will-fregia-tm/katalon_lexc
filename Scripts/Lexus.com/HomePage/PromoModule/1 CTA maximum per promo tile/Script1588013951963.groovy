...
WebUI.verifyElementPresent(findTestObject('HomePage/PromoModule/tile CTA'), 0)

WebUI.verifyElementNotPresent(findTestObject('HomePage/PromoModule/tile CTA 2'), 0)
