...
WebUI.verifyElementPresent(findTestObject('Accessibility/Headline'), 3)

headline = WebUI.getText(findTestObject('Accessibility/Headline'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyMatch(headline, 'ACCESSIBILITY', false, FailureHandling.STOP_ON_FAILURE)
