...
WebUI.waitForElementPresent(findTestObject('FCV/hero module'), 4, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('GlobalNav/lexus logo'), 3)
