...
imagewidth = WebUI.getCSSValue(findTestObject('Accessibility/Hero Image'), 'width')

imagewidth = (imagewidth - 'px')

int imagewidth = imagewidth.toInteger()

'display in full width in any resolution.'
WebUI.verifyEqual(imagewidth, pagewidth)

not_run: pageWidth = WebUI.getPageWidth()

not_run: String pageWidth = pageWidth

not_run: imageWidth = WebUI.getElementWidth(findTestObject('Accessibility/Hero Image'))

not_run: imageWidth = imageWidth.replaceAll(',', '')

not_run: WebUI.verifyMatch(pageWidth, imageWidth, false, FailureHandling.OPTIONAL)
