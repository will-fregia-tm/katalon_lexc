...
if (WebUI.verifyGreaterThan(pageWidth, '960', FailureHandling.OPTIONAL)) {
    ...
    WebUI.verifyElementPresent(findTestObject('ModelPages/InformationLayer/trim heading - LC 500h'), 0)

    WebUI.click(findTestObject('ModelPages/InformationLayer/remove CTA - second column'), FailureHandling.OPTIONAL)

    WebUI.waitForElementNotPresent(findTestObject('ModelPages/InformationLayer/trim heading - LC 500h'), 0)

    WebUI.verifyElementNotPresent(findTestObject('ModelPages/InformationLayer/trim heading - LC 500h'), 0)
