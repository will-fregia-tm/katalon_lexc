...
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Performance/asterisk disclaimer 1'), 3, FailureHandling.OPTIONAL)) {
    WebUI.delay(1)
    ...
    WebUI.click(findTestObject('ModelPages/Performance/asterisk disclaimer 1'), FailureHandling.STOP_ON_FAILURE)
    ...
    expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 750)
...
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Performance/story link 2'), 3, FailureHandling.OPTIONAL)) {
    WebUI.delay(1, FailureHandling.STOP_ON_FAILURE)

    WebUI.click(findTestObject('ModelPages/Performance/story link 2'))
    ...
    if (WebUI.verifyElementPresent(findTestObject('ModelPages/Performance/asterisk disclaimer 1'), 3, FailureHandling.OPTIONAL)) {
        ...
        expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 780)
...
'continues testing if there is another story link available'
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Performance/story link 3'), 3, FailureHandling.OPTIONAL)) {
    WebUI.click(findTestObject('ModelPages/Performance/story link 3'))
    ...
    if (WebUI.verifyElementPresent(findTestObject('ModelPages/Performance/asterisk disclaimer 1'), 3, FailureHandling.OPTIONAL)) {
        ...
        expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 810)
...
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Performance/drawer/more features link'), 3, FailureHandling.OPTIONAL)) {
    ...
    'tests if asterisk disclaimer is present'
    if (WebUI.verifyElementPresent(findTestObject('ModelPages/Performance/drawer/asterisk disclaimer 1'), 3, FailureHandling.OPTIONAL)) {
        WebUI.verifyElementNotPresent(findTestObject('ModelPages/Disclaimers/disclaimer copy'), 0)

        'When a user tap/clicks on a disclaimer "*" on the model page'
        WebUI.click(findTestObject('ModelPages/Performance/drawer/asterisk disclaimer 1'), FailureHandling.STOP_ON_FAILURE)
        ...
        expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 840)
        ...
        'tests if asterisk disclaimer is present'
        if (WebUI.verifyElementPresent(findTestObject('ModelPages/Performance/drawer/asterisk disclaimer 2'), 3, FailureHandling.OPTIONAL)) {
            WebUI.click(findTestObject('ModelPages/Performance/drawer/asterisk disclaimer 2'), FailureHandling.STOP_ON_FAILURE)
            ...
            expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 870)
            ...
            'tests if asterisk disclaimer is present'
            if (WebUI.verifyElementPresent(findTestObject('ModelPages/Performance/drawer/asterisk disclaimer 3'), 3, FailureHandling.OPTIONAL)) {
                WebUI.click(findTestObject('ModelPages/Performance/drawer/asterisk disclaimer 3'), FailureHandling.STOP_ON_FAILURE)
                ...
                expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 900)
