...
if (WebUI.verifyGreaterThan(pageWidth, '960', FailureHandling.OPTIONAL)) {
    ...
    WebUI.waitForElementPresent(findTestObject('ModelPages/InformationLayer/trim heading - RX base trim'), 0)

    WebUI.verifyElementPresent(findTestObject('ModelPages/InformationLayer/trim heading - RX base trim'), 0)
    ...
    WebUI.waitForElementNotPresent(findTestObject('ModelPages/InformationLayer/trim heading - NX 300h AWD'), 0)

    WebUI.verifyElementNotPresent(findTestObject('ModelPages/InformationLayer/trim heading - NX 300h AWD'), 0)
