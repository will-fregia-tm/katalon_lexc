...
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Design/drawer/more features link'), 3, FailureHandling.OPTIONAL)) {
    WebUI.scrollToElement(findTestObject('ModelPages/Design/copy heading'), 0)
    ...
    WebUI.scrollToElement(findTestObject('ModelPages/Design/drawer/feature 1 heading'), 0)
