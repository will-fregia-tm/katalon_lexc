...
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Technology/asterisk disclaimer 1'), 3, FailureHandling.OPTIONAL)) {
    WebUI.delay(1)
    ...
    WebUI.click(findTestObject('ModelPages/Technology/asterisk disclaimer 1'), FailureHandling.STOP_ON_FAILURE)
    ...
    expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 930)
...
'continues testing if there is another hotspot available'
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Technology/hotspot 2'), 3, FailureHandling.OPTIONAL)) {
    WebUI.delay(1, FailureHandling.STOP_ON_FAILURE)

    WebUI.click(findTestObject('ModelPages/Technology/hotspot 2'))
    ...
    if (WebUI.verifyElementPresent(findTestObject('ModelPages/Technology/asterisk disclaimer 1'), 3, FailureHandling.OPTIONAL)) {
        ...
        expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 960)
...
'continues testing if there is another hotspot available'
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Technology/hotspot 3'), 3, FailureHandling.OPTIONAL)) {
    WebUI.click(findTestObject('ModelPages/Technology/hotspot 3'))
    ...
    if (WebUI.verifyElementPresent(findTestObject('ModelPages/Technology/asterisk disclaimer 1'), 3, FailureHandling.OPTIONAL)) {
        ...
        expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 990)
...
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Technology/drawer/more features link'), 3, FailureHandling.OPTIONAL)) {
    not_run: WebUI.scrollToElement(findTestObject('ModelPages/Technology/drawer/more features link'), 0)
    ...
    'tests if asterisk disclaimer is present'
    if (WebUI.verifyElementPresent(findTestObject('ModelPages/Technology/drawer/asterisk disclaimer 1'), 3, FailureHandling.OPTIONAL)) {
        WebUI.verifyElementNotPresent(findTestObject('ModelPages/Disclaimers/disclaimer copy'), 0)

        'When a user tap/clicks on a disclaimer "*" on the model page'
        WebUI.click(findTestObject('ModelPages/Technology/drawer/asterisk disclaimer 1'), FailureHandling.STOP_ON_FAILURE)
        ...
        expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 1020)
        ...
        'tests if asterisk disclaimer is present'
        if (WebUI.verifyElementPresent(findTestObject('ModelPages/Technology/drawer/asterisk disclaimer 2'), 3, FailureHandling.OPTIONAL)) {
            WebUI.click(findTestObject('ModelPages/Technology/drawer/asterisk disclaimer 2'), FailureHandling.STOP_ON_FAILURE)
            ...
            expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 1050)
            ...
            'tests if asterisk disclaimer is present'
            if (WebUI.verifyElementPresent(findTestObject('ModelPages/Technology/drawer/asterisk disclaimer 3'), 3, FailureHandling.OPTIONAL)) {
                WebUI.click(findTestObject('ModelPages/Technology/drawer/asterisk disclaimer 3'), FailureHandling.STOP_ON_FAILURE)
                ...
                expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 1080)
