...
WebUI.mouseOver(findTestObject('ModelPages/Styles/BYL CTA'), FailureHandling.OPTIONAL)
...
not_run: accessoriesTarget = WebUI.getAttribute(findTestObject('ModelPages/Styles/Accessories link'), 'target')
