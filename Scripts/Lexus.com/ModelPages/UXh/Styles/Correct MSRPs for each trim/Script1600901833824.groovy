...
if (WebUI.verifyGreaterThan(pageWidth, '1204', FailureHandling.OPTIONAL)) {
    ...
    not_run: WebUI.verifyElementVisible(findTestObject('ModelPages/Styles/model-style 7 starting at price - desktop'), FailureHandling.STOP_ON_FAILURE)

    not_run: textWithMSRP = WebUI.getText(findTestObject('ModelPages/Styles/model-style 7 starting at price - desktop'), 
        FailureHandling.STOP_ON_FAILURE)

    'UX 250h AWD BLACK LINE SPECIAL EDITION'
    not_run: expectedMSRP = findTestData(GlobalVariable.DS_version + 'MSRPs').getValue(4, 99)
