...
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Performance/drawer/more features link'), 3, FailureHandling.OPTIONAL)) {
    WebUI.scrollToElement(findTestObject('ModelPages/Performance/copy heading'), 0)
    ...
    WebUI.scrollToElement(findTestObject('ModelPages/Performance/drawer/feature 1 heading'), 0)
