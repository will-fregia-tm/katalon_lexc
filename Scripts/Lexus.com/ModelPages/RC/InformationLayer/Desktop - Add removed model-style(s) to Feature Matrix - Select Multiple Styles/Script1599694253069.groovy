...
if (WebUI.verifyGreaterThan(pageWidth, '960', FailureHandling.OPTIONAL)) {
    ...
    WebUI.waitForElementPresent(findTestObject('ModelPages/InformationLayer/trim heading - RC 300'), 0)

    WebUI.verifyElementPresent(findTestObject('ModelPages/InformationLayer/trim heading - RC 300'), 0)
