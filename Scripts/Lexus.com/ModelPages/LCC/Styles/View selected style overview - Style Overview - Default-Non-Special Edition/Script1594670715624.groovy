...
WebUI.openBrowser((GlobalVariable.TS_Domain + GlobalVariable.Overview_LCC) + '/styles')
...
if (WebUI.verifyGreaterThan(pageWidth, '1204', FailureHandling.OPTIONAL)) {
    ...
    WebUI.verifyElementPresent(findTestObject('ModelPages/Styles/model-style sub-name - desktop'), 5, FailureHandling.STOP_ON_FAILURE)
    ...
    not_run: WebUI.scrollToElement(findTestObject('ModelPages/divider 1'), 0)

    not_run: WebUI.scrollToElement(findTestObject('ModelPages/Styles/styles heading'), 0)
...
if (WebUI.verifyLessThan(pageWidth, '1204', FailureHandling.OPTIONAL)) {
    ...
    WebUI.verifyElementPresent(findTestObject('ModelPages/Styles/hybrid model-style name - mobile'), 5)
