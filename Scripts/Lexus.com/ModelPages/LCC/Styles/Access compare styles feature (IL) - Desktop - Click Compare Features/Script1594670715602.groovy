...
if (WebUI.verifyGreaterThan(pageWidth, '960', FailureHandling.OPTIONAL)) {
    ...
    WebUI.verifyElementVisibleInViewport(findTestObject('ModelPages/Styles/trim 3 link'), 0, FailureHandling.OPTIONAL)
    ...
    activeHighlight = WebUI.getCSSValue(findTestObject('ModelPages/InformationLayer/column 3'), 'background', FailureHandling.STOP_ON_FAILURE)
