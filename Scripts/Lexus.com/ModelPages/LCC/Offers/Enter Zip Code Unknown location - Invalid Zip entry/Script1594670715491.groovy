...
WebUI.navigateToUrl(GlobalVariable.TS_Domain + GlobalVariable.Overview_LCC)

WebUI.navigateToUrl(GlobalVariable.TS_Domain_Unauthenticated + GlobalVariable.Overview_LCC)

WebUI.waitForPageLoad(0)

WebUI.scrollToElement(findTestObject('ModelPages/Offers/offers module'), 0)

WebUI.setText(findTestObject('ModelPages/Offers/zip entry field'), 'abcde')
...
WebUI.setText(findTestObject('ModelPages/Offers/zip entry field'), '11111')
...
WebUI.waitForElementVisible(findTestObject('ModelPages/Offers/invalid zip code message'), 0)

WebUI.verifyElementVisibleInViewport(findTestObject('ModelPages/Offers/invalid zip code message'), 0)
