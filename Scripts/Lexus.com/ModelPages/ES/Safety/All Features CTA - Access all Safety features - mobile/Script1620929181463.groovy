...
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Safety/drawer/more features link'), 3, FailureHandling.OPTIONAL)) {
    WebUI.scrollToElement(findTestObject('ModelPages/Safety/copy heading'), 0)
    ...
    WebUI.scrollToElement(findTestObject('ModelPages/Safety/drawer/feature 1 heading'), 0)

    WebUI.delay(1, FailureHandling.STOP_ON_FAILURE)

    WebUI.click(findTestObject('ModelPages/Safety/drawer/all features CTA'), FailureHandling.STOP_ON_FAILURE)

    WebUI.delay(1, FailureHandling.STOP_ON_FAILURE)

    actualValue = WebUI.getText(findTestObject('ModelPages/InformationLayer/selected tab'), FailureHandling.STOP_ON_FAILURE)

    'Clicking on All Safety CTA leads to IL features tab'
    ...
    expectedValue = 'SAFETY'

    valueWithoutExpected = (actualValue - expectedValue)

    'Clicking on All Safety CTA leads to open Safety accordion.'
