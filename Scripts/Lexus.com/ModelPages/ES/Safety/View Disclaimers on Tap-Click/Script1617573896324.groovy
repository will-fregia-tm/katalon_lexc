...
WebUI.click(findTestObject('ModelPages/Subnav/safety link'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3)

'tests if asterisk disclaimer is present'
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Safety/asterisk disclaimer 1'), 3, FailureHandling.OPTIONAL)) {
    WebUI.delay(1)
    ...
    WebUI.click(findTestObject('ModelPages/Safety/asterisk disclaimer 1'), FailureHandling.STOP_ON_FAILURE)
    ...
    expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 1110)
    ...
    'tests if asterisk disclaimer is present'
    if (WebUI.verifyElementPresent(findTestObject('ModelPages/Safety/asterisk disclaimer 2'), 3, FailureHandling.OPTIONAL)) {
        WebUI.delay(1)

        WebUI.verifyElementNotPresent(findTestObject('ModelPages/Disclaimers/disclaimer copy'), 0)

        'When a user tap/clicks on a disclaimer "*" on the model page'
        WebUI.click(findTestObject('ModelPages/Safety/asterisk disclaimer 2'), FailureHandling.STOP_ON_FAILURE)
        ...
        expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 1140)
...
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Safety/drawer/more features link'), 3, FailureHandling.OPTIONAL)) {
    ...
    'tests if asterisk disclaimer is present'
    if (WebUI.verifyElementPresent(findTestObject('ModelPages/Safety/drawer/asterisk disclaimer 1'), 3, FailureHandling.OPTIONAL)) {
        WebUI.verifyElementNotPresent(findTestObject('ModelPages/Disclaimers/disclaimer copy'), 0)

        'When a user tap/clicks on a disclaimer "*" on the model page'
        WebUI.click(findTestObject('ModelPages/Safety/drawer/asterisk disclaimer 1'), FailureHandling.STOP_ON_FAILURE)
        ...
        expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 1170)
        ...
        'tests if asterisk disclaimer is present'
        if (WebUI.verifyElementPresent(findTestObject('ModelPages/Safety/drawer/asterisk disclaimer 2'), 3, FailureHandling.OPTIONAL)) {
            WebUI.click(findTestObject('ModelPages/Safety/drawer/asterisk disclaimer 2'), FailureHandling.STOP_ON_FAILURE)
            ...
            expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 1200)
            ...
            'tests if asterisk disclaimer is present'
            if (WebUI.verifyElementPresent(findTestObject('ModelPages/Safety/drawer/asterisk disclaimer 3'), 3, FailureHandling.OPTIONAL)) {
                WebUI.click(findTestObject('ModelPages/Safety/drawer/asterisk disclaimer 3'), FailureHandling.STOP_ON_FAILURE)
                ...
                expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 1230)
