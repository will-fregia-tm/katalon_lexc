...
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Hero/asterisk disclaimer 1'), 3, FailureHandling.OPTIONAL)) {
    ...
    WebUI.click(findTestObject('ModelPages/Hero/asterisk disclaimer 1'), FailureHandling.STOP_ON_FAILURE)
    ...
    expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 270)
    ...
    'tests if asterisk disclaimer is present'
    if (WebUI.verifyElementPresent(findTestObject('ModelPages/Hero/asterisk disclaimer 2'), 3, FailureHandling.OPTIONAL)) {
        WebUI.verifyElementNotPresent(findTestObject('ModelPages/Disclaimers/disclaimer copy'), 0)

        WebUI.click(findTestObject('ModelPages/Hero/asterisk disclaimer 2'), FailureHandling.STOP_ON_FAILURE)
        ...
        'tests if asterisk disclaimer is present'
        if (WebUI.verifyElementPresent(findTestObject('ModelPages/Hero/asterisk disclaimer 3'), 3, FailureHandling.OPTIONAL)) {
            WebUI.verifyElementNotPresent(findTestObject('ModelPages/Disclaimers/disclaimer copy'), 0)

            WebUI.click(findTestObject('ModelPages/Hero/asterisk disclaimer 3'), FailureHandling.STOP_ON_FAILURE)
