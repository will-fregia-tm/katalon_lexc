...
WebUI.scrollToElement(findTestObject('ModelPages/Visualizer/visualizer module'), 0)

'tests if asterisk disclaimer is present'
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Visualizer/asterisk disclaimer 1'), 3, FailureHandling.OPTIONAL)) {
    WebUI.delay(1)
    ...
    WebUI.click(findTestObject('ModelPages/Visualizer/asterisk disclaimer 1'), FailureHandling.STOP_ON_FAILURE)
    ...
    expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 450)
    ...
    'tests if asterisk disclaimer is present'
    if (WebUI.verifyElementPresent(findTestObject('ModelPages/Visualizer/asterisk disclaimer 2'), 3, FailureHandling.OPTIONAL)) {
        WebUI.verifyElementNotPresent(findTestObject('ModelPages/Disclaimers/disclaimer copy'), 0)

        WebUI.click(findTestObject('ModelPages/Visualizer/asterisk disclaimer 2'), FailureHandling.STOP_ON_FAILURE)
        ...
        expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 300)
        ...
        'tests if asterisk disclaimer is present'
        if (WebUI.verifyElementPresent(findTestObject('ModelPages/Visualizer/asterisk disclaimer 3'), 3, FailureHandling.OPTIONAL)) {
            WebUI.verifyElementNotPresent(findTestObject('ModelPages/Disclaimers/disclaimer copy'), 0)

            WebUI.click(findTestObject('ModelPages/Visualizer/asterisk disclaimer 3'), FailureHandling.STOP_ON_FAILURE)
            ...
            expectedValue = findTestData('modelData').getValue(GlobalVariable.dataColumn, seriesKey + 330)
