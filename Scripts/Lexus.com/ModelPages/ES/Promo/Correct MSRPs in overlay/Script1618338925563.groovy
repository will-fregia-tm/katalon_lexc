...
if (WebUI.verifyElementNotPresent(findTestObject('ModelPages/Overlay/overlay'), 10, FailureHandling.OPTIONAL)) {
    WebUI.refresh()
}
...
if (WebUI.verifyElementPresent(findTestObject('ModelPages/Overlay/starting at price 1'), 3, FailureHandling.OPTIONAL)) {
    ...
    actualValue = WebUI.getText(findTestObject('ModelPages/Overlay/starting at price 1'), FailureHandling.STOP_ON_FAILURE)

    int trimCode1 = findTestData('trimCode_' + modelName).getValue(1, 1).toInteger()

    expectedValue = findTestData('MSRP').getValue(GlobalVariable.dataColumn, trimCode1)
    ...
    'continues testing if there is another MSRP present'
    if (WebUI.verifyElementPresent(findTestObject('ModelPages/Overlay/starting at price 2'), 3, FailureHandling.OPTIONAL)) {
        modelName = WebUI.getText(findTestObject('ModelPages/Overlay/trim model name 2'), FailureHandling.STOP_ON_FAILURE)

        actualValue = WebUI.getText(findTestObject('ModelPages/Overlay/starting at price 2'), FailureHandling.STOP_ON_FAILURE)
        ...
        'continues testing if there is another MSRP present'
        if (WebUI.verifyElementPresent(findTestObject('ModelPages/Overlay/starting at price 3'), 3, FailureHandling.OPTIONAL)) {
            modelName = WebUI.getText(findTestObject('ModelPages/Overlay/trim model name 3'), FailureHandling.STOP_ON_FAILURE)

            actualValue = WebUI.getText(findTestObject('ModelPages/Overlay/starting at price 3'), FailureHandling.STOP_ON_FAILURE)
            ...
            'continues testing if there is another MSRP present'
            if (WebUI.verifyElementPresent(findTestObject('ModelPages/Overlay/starting at price 4'), 3, FailureHandling.OPTIONAL)) {
                modelName = WebUI.getText(findTestObject('ModelPages/Overlay/trim model name 4'), FailureHandling.STOP_ON_FAILURE)

                actualValue = WebUI.getText(findTestObject('ModelPages/Overlay/starting at price 4'), FailureHandling.STOP_ON_FAILURE)
