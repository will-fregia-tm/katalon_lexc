...
if (WebUI.verifyGreaterThan(pageWidth, '960', FailureHandling.OPTIONAL)) {
    ...
    WebUI.waitForElementNotPresent(findTestObject('ModelPages/InformationLayer/trim heading - ES 250 AWD'), 0)

    WebUI.verifyElementNotPresent(findTestObject('ModelPages/InformationLayer/trim heading - ES 250 AWD'), 0)
