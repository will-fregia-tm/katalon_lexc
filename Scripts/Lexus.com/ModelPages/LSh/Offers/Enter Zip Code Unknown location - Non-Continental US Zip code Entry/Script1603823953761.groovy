...
WebUI.navigateToUrl(GlobalVariable.TS_Domain_Unauthenticated + GlobalVariable.Overview_LSh)

WebUI.waitForPageLoad(0)

WebUI.scrollToElement(findTestObject('ModelPages/Offers/offers module'), 0)

WebUI.setText(findTestObject('ModelPages/Offers/zip entry field'), '00901')
...
WebUI.verifyElementVisible(findTestObject('ModelPages/Offers/Puerto Rico dealers link'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('ModelPages/Offers/Puerto Rico dealers link'), FailureHandling.STOP_ON_FAILURE)
...
not_run: if (WebUI.verifyElementPresent(findTestObject('ModelPages/Offers/interstitial'), 5, FailureHandling.OPTIONAL)) {
    ...
    WebUI.focus(findTestObject('ModelPages/Offers/interstital continue CTA'))

    WebUI.sendKeys(findTestObject('ModelPages/Offers/interstital continue CTA'), Keys.chord(Keys.ENTER))
}
...
WebUI.navigateToUrl(GlobalVariable.TS_Domain_Unauthenticated + GlobalVariable.Overview_LS)
