...
if (WebUI.verifyGreaterThan(pageWidth, '960', FailureHandling.OPTIONAL)) {
    ...
    WebUI.waitForElementNotPresent(findTestObject('ModelPages/InformationLayer/trim heading - IS 300'), 0)

    WebUI.verifyElementNotPresent(findTestObject('ModelPages/InformationLayer/trim heading - IS 300'), 0)
