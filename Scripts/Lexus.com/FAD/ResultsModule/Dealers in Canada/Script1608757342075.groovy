...
WebUI.waitForElementPresent(findTestObject('FAD/ResultsModule/dealers in canada link'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToElement(findTestObject('FAD/ResultsModule/dealers in canada link'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('FAD/ResultsModule/dealers in canada link'), FailureHandling.STOP_ON_FAILURE)
