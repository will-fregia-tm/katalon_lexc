...
WebUI.setText(findTestObject('FAD/ResultsModule/dealer name input field'), 'manhattan', FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('FAD/ResultsModule/zipcode tab'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyMatch(firstDealer, thirdDealer, false, FailureHandling.STOP_ON_FAILURE)
