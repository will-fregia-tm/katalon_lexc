...
WebUI.waitForElementPresent(findTestObject('FAD/ResultsModule/se habla espanol'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('FAD/ResultsModule/se habla espanol'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToElement(findTestObject('FAD/ResultsModule/se habla espanol'), 0, FailureHandling.OPTIONAL)
