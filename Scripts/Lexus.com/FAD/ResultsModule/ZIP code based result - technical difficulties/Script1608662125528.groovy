...
WebUI.setText(findTestObject('FAD/ZipGate/zip entry dialog box'), '00001', FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('FAD/ZipGate/search icon'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('FAD/ResultsModule/technical difficulties message'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('FAD/ResultsModule/technical difficulties message'), 0, FailureHandling.STOP_ON_FAILURE)
