...
WebUI.verifyElementPresent(findTestObject('FAD/DealerDetails/dealer site CTA'), 0, FailureHandling.STOP_ON_FAILURE)

dealerSite = WebUI.getAttribute(findTestObject('FAD/DealerDetails/dealer site CTA'), 'href', FailureHandling.STOP_ON_FAILURE)

modifiedString = (dealerSite - '.com')
...
WebUI.click(findTestObject('FAD/DealerDetails/dealer site CTA'), FailureHandling.STOP_ON_FAILURE)
...
'verifies that dealer site URL leads to a dealer page'
...
WebUI.verifyElementPresent(findTestObject('FAD/DealerDetails/contact dealer CTA'), 0, FailureHandling.STOP_ON_FAILURE)

dealerContact = WebUI.getAttribute(findTestObject('FAD/DealerDetails/contact dealer CTA'), 'href', FailureHandling.STOP_ON_FAILURE)

modifiedString = (dealerContact - '.com')
...
modifiedString = (windowTitle - 'Contact')

'verifies that contact URL leads to a dealer contact page'
WebUI.verifyNotMatch(modifiedString, windowTitle, false, FailureHandling.STOP_ON_FAILURE)
