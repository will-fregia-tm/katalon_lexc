...
WebUI.verifyElementPresent(findTestObject('FAD/DealerDetails/page title'), 0, FailureHandling.STOP_ON_FAILURE)

titleJustify = WebUI.getCSSValue(findTestObject('FAD/DealerDetails/page title'), 'justify-content', FailureHandling.STOP_ON_FAILURE)

WebUI.verifyMatch(titleJustify, 'center', false, FailureHandling.STOP_ON_FAILURE)

dealerName = WebUI.getText(findTestObject('FAD/DealerDetails/page title'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyMatch(dealerName, 'JIM FALK LEXUS OF BEVERLY HILLS', false, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementNotPresent(findTestObject('FAD/DealerDetails/elite dealer icon - page title'), 0, FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyMatch(dealerName, 'SEWELL LEXUS', false, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('FAD/DealerDetails/elite dealer icon - page title'), 0, FailureHandling.STOP_ON_FAILURE)
