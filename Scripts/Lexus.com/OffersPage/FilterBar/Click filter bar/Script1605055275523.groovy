...
WebUI.verifyElementPresent(findTestObject('OffersPage/FilterBar/close accordion button'), 0)

WebUI.verifyElementVisible(findTestObject('OffersPage/FilterBar/expanded filter bar menu'), FailureHandling.STOP_ON_FAILURE)
