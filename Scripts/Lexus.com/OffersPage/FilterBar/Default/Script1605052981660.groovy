...
WebUI.verifyElementPresent(findTestObject('OffersPage/FilterBar/filter bar'), 0)

WebUI.verifyElementNotPresent(findTestObject('OffersPage/FilterBar/close accordion button'), 0)

FilterBarTitle = WebUI.getCSSValue(findTestObject('OffersPage/FilterBar/filter bar'), 'justify-content', FailureHandling.STOP_ON_FAILURE)

WebUI.verifyMatch(FilterBarTitle, 'center', false, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementClickable(findTestObject('OffersPage/FilterBar/filter bar'), FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToPosition(0, 1000, FailureHandling.OPTIONAL)

FilterBarPosition = WebUI.getCSSValue(findTestObject('OffersPage/FilterBar/filter bar position'), 'position', FailureHandling.STOP_ON_FAILURE)

WebUI.verifyMatch(FilterBarPosition, 'sticky', false, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisibleInViewport(findTestObject('OffersPage/FilterBar/filter bar'), 0, FailureHandling.STOP_ON_FAILURE)
