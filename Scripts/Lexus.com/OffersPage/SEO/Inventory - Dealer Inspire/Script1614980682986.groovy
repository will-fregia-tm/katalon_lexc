...
WebUI.waitForElementPresent(findTestObject('OffersPage/SEO/city - Pembroke Pines'), 5, FailureHandling.OPTIONAL)

WebUI.click(findTestObject('OffersPage/SEO/city - Pembroke Pines'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementClickable(findTestObject('OffersPage/SEO/inventory CTA - Dealer Inspire'), FailureHandling.STOP_ON_FAILURE)

'CTA 2 - Inventory - Will drive users to the Dealer Site Inventory page'
href = WebUI.getAttribute(findTestObject('OffersPage/SEO/inventory CTA - Dealer Inspire'), 'href', FailureHandling.STOP_ON_FAILURE)
...
'CTA 2 - Inventory - Will drive users to the Dealer Site Inventory page'
WebUI.click(findTestObject('OffersPage/SEO/inventory CTA - Dealer Inspire'), FailureHandling.STOP_ON_FAILURE)
