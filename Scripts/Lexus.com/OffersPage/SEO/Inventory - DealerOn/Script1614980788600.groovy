...
WebUI.waitForElementPresent(findTestObject('OffersPage/SEO/state - Texas'), 5, FailureHandling.OPTIONAL)
...
WebUI.waitForElementPresent(findTestObject('OffersPage/SEO/city - Plano'), 5, FailureHandling.OPTIONAL)
...
WebUI.verifyElementClickable(findTestObject('OffersPage/SEO/inventory CTA - DealerOn'), FailureHandling.STOP_ON_FAILURE)

'CTA 2 - Inventory - Will drive users to the Dealer Site Inventory page'
href = WebUI.getAttribute(findTestObject('OffersPage/SEO/inventory CTA - DealerOn'), 'href', FailureHandling.STOP_ON_FAILURE)

'dealer inventory link should include this specific search parameter'
modifiedString = (href - 'searchnew.aspx?')

WebUI.verifyNotMatch(modifiedString, href, false, FailureHandling.STOP_ON_FAILURE)

'CTA 2 - Inventory - Will drive users to the Dealer Site Inventory page'
WebUI.click(findTestObject('OffersPage/SEO/inventory CTA - DealerOn'), FailureHandling.STOP_ON_FAILURE)
