...
WebUI.verifyElementClickable(findTestObject('OffersPage/SEO/inventory CTA - Dealer.com'), FailureHandling.STOP_ON_FAILURE)

'CTA 2 - Inventory - Will drive users to the Dealer Site Inventory page'
href = WebUI.getAttribute(findTestObject('OffersPage/SEO/inventory CTA - Dealer.com'), 'href', FailureHandling.STOP_ON_FAILURE)
...
'CTA 2 - Inventory - Will drive users to the Dealer Site Inventory page'
WebUI.click(findTestObject('OffersPage/SEO/inventory CTA - Dealer.com'), FailureHandling.STOP_ON_FAILURE)
