...
WebUI.verifyElementPresent(findTestObject('OffersPage/ZipBar/numbers in zip input'), 2, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OffersPage/ZipBar/search icon'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('OffersPage/ZipBar/updated zip bar'), 2, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('OffersPage/ZipBar/updated zip bar'), 2, FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementPresent(findTestObject('OffersPage/ZipBar/zip bar'), 2, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('OffersPage/ZipBar/zip bar'), 2, FailureHandling.STOP_ON_FAILURE)
