...
WebUI.click(findTestObject('OffersPage/FilterBar/model checkbox - UXh'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('OffersPage/FilterBar/model checkbox - RXh'), FailureHandling.STOP_ON_FAILURE)
