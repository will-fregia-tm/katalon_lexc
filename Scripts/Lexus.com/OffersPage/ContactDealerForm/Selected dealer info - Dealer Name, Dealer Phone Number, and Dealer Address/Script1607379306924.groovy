...
WebUI.verifyElementVisibleInViewport(findTestObject('OffersPage/ContactDealerForm/dealer address'), 0, FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementVisibleInViewport(findTestObject('OffersPage/ContactDealerForm/dealer phone number'), 0, FailureHandling.STOP_ON_FAILURE)
