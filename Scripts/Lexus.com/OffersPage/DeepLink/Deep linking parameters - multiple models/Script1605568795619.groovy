...
WebUI.navigateToUrl(GlobalVariable.SC_Domain + '/offers?zip=30303&model=IS&model=ES&model=UX', FailureHandling.STOP_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('OffersPage/FilterBar/offer heading - IS'), 0, FailureHandling.OPTIONAL)

WebUI.verifyElementPresent(findTestObject('OffersPage/FilterBar/offer heading - ES'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToElement(findTestObject('OffersPage/FilterBar/offer heading - ES'), 0, FailureHandling.OPTIONAL)

WebUI.verifyElementPresent(findTestObject('OffersPage/FilterBar/offer heading - UX'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToElement(findTestObject('OffersPage/FilterBar/offer heading - UX'), 0, FailureHandling.OPTIONAL)
