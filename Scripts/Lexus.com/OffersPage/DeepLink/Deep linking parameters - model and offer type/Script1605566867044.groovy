...
WebUI.navigateToUrl(GlobalVariable.SC_Domain + '/offers?zip=30303&model=IS&offerType=lease', FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('OffersPage/FilterBar/breadcrumb - lease'), 0, FailureHandling.STOP_ON_FAILURE)
