...
WebUI.navigateToUrl(GlobalVariable.SC_Domain + '/offers?zip=08008', FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('OffersPage/SharedMarketOverlay/showing results text'), 0, FailureHandling.STOP_ON_FAILURE)
