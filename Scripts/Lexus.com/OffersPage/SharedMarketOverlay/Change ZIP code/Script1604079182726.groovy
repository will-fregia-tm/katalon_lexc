...
WebUI.navigateToUrl(GlobalVariable.SC_Domain + '/offers?zip=75219')
...
WebUI.verifyElementPresent(findTestObject('OffersPage/ZipBar/numbers in zip input - 08008'), 2, FailureHandling.STOP_ON_FAILURE)
