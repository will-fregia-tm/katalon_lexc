...
WebUI.verifyElementVisibleInViewport(findTestObject('OffersPage/OfferDetails/market dealer results'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.scrollToElement(findTestObject('OffersPage/OfferDetails/market dealer results'), 0, FailureHandling.OPTIONAL)
