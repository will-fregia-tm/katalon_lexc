...
WebUI.setText(findTestObject('OffersPage/ZipGate/form input'), '96701')

WebUI.click(findTestObject('OffersPage/ZipGate/submit button'))

WebUI.waitForElementPresent(findTestObject('OffersPage/ZipGate/hawaii server message'), 5, FailureHandling.OPTIONAL)

WebUI.verifyElementPresent(findTestObject('OffersPage/ZipGate/hawaii server message'), 0, FailureHandling.STOP_ON_FAILURE)
