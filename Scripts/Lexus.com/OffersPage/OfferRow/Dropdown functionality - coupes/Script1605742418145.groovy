...
WebUI.click(findTestObject('OffersPage/FilterBar/model-category - Coupes'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OffersPage/FilterBar/model-category checkbox - All Coupes'), FailureHandling.STOP_ON_FAILURE)
