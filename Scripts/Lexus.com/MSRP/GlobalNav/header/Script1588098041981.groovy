...
WebUI.waitForElementPresent(findTestObject('GlobalNav/header/sedans'), 0, FailureHandling.OPTIONAL)

WebUI.mouseOver(findTestObject('GlobalNav/header/sedans'), FailureHandling.OPTIONAL)
...
not_run: textWithMSRP = WebUI.getAttribute(findTestObject('MSRP/section objects/global nav/sedans - GS - starting at price'), 
...
not_run: textWithMSRP = WebUI.getAttribute(findTestObject('MSRP/section objects/global nav/sedans - GS F - starting at price'), 
    'text', FailureHandling.STOP_ON_FAILURE)
...
WebUI.mouseOver(findTestObject('GlobalNav/header/coupes'), FailureHandling.OPTIONAL)
...
WebUI.mouseOver(findTestObject('GlobalNav/header/hybrids'), FailureHandling.OPTIONAL)
...
WebUI.mouseOver(findTestObject('GlobalNav/header/performance'), FailureHandling.OPTIONAL)
...
not_run: textWithMSRP = WebUI.getAttribute(findTestObject('MSRP/section objects/global nav/performance - GS F - starting at price'), 
    'text', FailureHandling.STOP_ON_FAILURE)
...
if (WebUI.verifyElementPresent(findTestObject('MSRP/section objects/global nav/performance - LC C starting at price'), 0, 
