...
WebUI.navigateToUrl(GlobalVariable.TS_Domain + '/compare/series/LC')

textWithMSRP = WebUI.getText(findTestObject('MSRP/section objects/compare/series pages - JATO IDs/LC/LC 500 - starting at price'))
...
textWithMSRP = WebUI.getText(findTestObject('MSRP/section objects/compare/series pages - JATO IDs/LC/LC 500h - starting at price'))
