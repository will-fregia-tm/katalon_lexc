...
WebUI.navigateToUrl(GlobalVariable.TS_Domain + '/compare/LC/competitor/77912502021', FailureHandling.STOP_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('MSRP/section objects/compare/trim pages/coupes/coupes - model series 05'), 0, FailureHandling.OPTIONAL)

coupesModelSeries05text = ''

WebUI.click(findTestObject('MSRP/section objects/compare/trim pages/coupes/coupes - add vehicle CTA 05'), FailureHandling.OPTIONAL)

coupesModelSeries05text = WebUI.getText(findTestObject('MSRP/section objects/compare/trim pages/coupes/coupes - model series 05 trims'), 
    FailureHandling.OPTIONAL)
...
not_run: textWithMSRP = WebUI.getText(findTestObject('MSRP/section objects/compare/trim pages/SUVs/SUVs'), FailureHandling.STOP_ON_FAILURE)

not_run: if (WebUI.verifyElementPresent(findTestObject('MSRP/section objects/compare/trim pages/active models/UX'), 0, FailureHandling.OPTIONAL)) {
    'UX 200 FWD'
...
not_run: if (WebUI.verifyElementPresent(findTestObject('MSRP/section objects/compare/trim pages/active models/NX'), 0, FailureHandling.OPTIONAL)) {
    'NX 300 FWD'
...
not_run: if (WebUI.verifyElementPresent(findTestObject('MSRP/section objects/compare/trim pages/active models/RX'), 0, FailureHandling.OPTIONAL)) {
    'RX 350 FWD'
...
not_run: if (WebUI.verifyElementPresent(findTestObject('MSRP/section objects/compare/trim pages/active models/GX'), 0, FailureHandling.OPTIONAL)) {
    'GX 460'
...
not_run: if (WebUI.verifyElementPresent(findTestObject('MSRP/section objects/compare/trim pages/active models/LX'), 0, FailureHandling.OPTIONAL)) {
    'LX 570 Two-Row'
