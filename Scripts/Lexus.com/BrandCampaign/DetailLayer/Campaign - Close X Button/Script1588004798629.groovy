...
WebUI.click(findTestObject('BrandCampaign/GridLayer/secondary tile'), FailureHandling.OPTIONAL)

WebUI.waitForElementVisible(findTestObject('BrandCampaign/DetailLayer/overlay close button'), 0, FailureHandling.OPTIONAL)

WebUI.verifyElementVisible(findTestObject('BrandCampaign/DetailLayer/video'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('BrandCampaign/DetailLayer/overlay close button'), FailureHandling.OPTIONAL)

WebUI.verifyElementVisible(findTestObject('BrandCampaign/GridLayer/primary tile'), FailureHandling.OPTIONAL)

WebUI.verifyElementPresent(findTestObject('BrandCampaign/GridLayer/secondary tile'), 0, FailureHandling.OPTIONAL)
