...
<WebElementEntity>
   ...
   <selectorCollection>
      ...
      <entry>
         <key>XPATH</key>
         <value>(//div[1]/h3[@letter-spacing = 'wide' and (not(contains(text(), 'SHOPPING')) and not(contains(text(), 'EXPLORE')))]/following-sibling::div)[1]//*[@data-index = '0']//img[contains(@src, 'image')]</value>
      </entry>
   </selectorCollection>
